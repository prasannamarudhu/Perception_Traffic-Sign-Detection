...
def hsv(img,OG):
    ...
    lower_blue = np.array([204, 255, 255])
    upper_blue = np.array([0, 0, 204])
...
def grayscale(c1,c2,c3,img):
    ...
    lower_blue = np.array([15, 15, 0])    #255, 150, 150
    upper_blue = np.array([55, 55, 50])
...
#for i in range(32640,35500):
#for i in range(32728,33395):
#for i in range(2032,2052): #Red
#for i in range(785,795):   #Red
for i in range(99,103):     #Blue
